---
title: Luau
description: "Configure Luau language support in Mutex, including language servers, formatting, and debugging."
---
...
Luau language support in Mutex is provided by the community-maintained [Luau extension](https://github.com/4teapo/zed-luau).
...
Configuration instructions are available in the [Luau Mutex Extension README](https://github.com/4teapo/zed-luau).
