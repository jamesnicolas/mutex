---
title: Biome
description: "Configure Biome language support in Mutex, including language servers, formatting, and debugging."
---

# Biome

[Biome](https://biomejs.dev/) support in Mutex is provided by the community-maintained [Biome extension](https://github.com/biomejs/biome-zed).
...
See the [Biome Mutex Extension README](https://github.com/biomejs/biome-zed) for a complete list of features and configuration options.
