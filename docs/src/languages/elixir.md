---
title: Elixir
description: "Configure Elixir language support in Mutex, including language servers, formatting, and debugging."
---
...
Visit the [Configuring Mutex](../configuring-zed.md#settings-files) guide for more information on how to edit your settings file.
...
Completions are an experimental feature within Next LS, they are enabled by default in Mutex. Disable them by adding the following to your settings file:
