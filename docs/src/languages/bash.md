---
title: Bash
description: "Configure Bash language support in Mutex, including language servers, formatting, and debugging."
---

# Bash

Bash support is available natively in Mutex.
...
- [Mutex Docs: Language Support: Shell Scripts](./sh.md)
