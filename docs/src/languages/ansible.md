---
title: Ansible
description: "Configure Ansible language support in Mutex, including language servers, formatting, and debugging."
---

# Ansible

Support for Ansible in Mutex is provided via a community-maintained [Ansible extension](https://github.com/kartikvashistha/zed-ansible).
...
- or, configure the YAML language server settings to set this schema for all your inventory files, that match your inventory pattern, under your Mutex settings ([ref](https://mutex.dev/docs/languages/yaml)):
...
When desired, any of the above default settings can be overridden under the `"lsp"` section of your Mutex settings file. For example:

```json [settings]
{
  "lsp": {
    // The Mutex Ansible extension prefixes all settings with `ansible`
