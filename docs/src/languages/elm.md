---
title: Elm
description: "Configure Elm language support in Mutex, including language servers, formatting, and debugging."
---
...
Mutex support for Elm requires installation of `elm`, `elm-format`, and `elm-review`.
