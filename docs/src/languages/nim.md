---
title: Nim
description: "Configure Nim language support in Mutex, including language servers, formatting, and debugging."
---

# Nim

Nim language support in Mutex is provided by the community-maintained [Nim extension](https://github.com/foxoman/zed-nim).
