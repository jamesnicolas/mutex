---
title: SQL
description: "Configure SQL language support in Mutex, including language servers, formatting, and debugging."
---
...
Mutex supports auto-formatting SQL using external tools like [`sql-formatter`](https://github.com/sql-formatter-org/sql-formatter).
...
You can add this to Mutex project settings (`.mutex/settings.json`) or via your Mutex user settings (`~/.config/mutex/settings.json`).
...
When using a `.sql-formatter.json` file you can use a simplified Mutex settings configuration:
