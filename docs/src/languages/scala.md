---
title: Scala
description: "Configure Scala language support in Mutex, including language servers, formatting, and debugging."
---

# Scala

Scala language support in Mutex is provided by the community-maintained [Scala extension](https://github.com/scalameta/metals-zed).
...
<!--
TBD: Provide LSP configuration example for metals in Mutex settings.json. metals.{javaHome,excludedPackages,customProjectRoot} etc.
-->
