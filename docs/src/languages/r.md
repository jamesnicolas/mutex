...
You can configure the [R languageserver settings](https://github.com/REditorSupport/languageserver#settings) via Mutex Project Settings `.zed/settings.json` or Mutex User Settings `~/.config/zed/settings.json`:
