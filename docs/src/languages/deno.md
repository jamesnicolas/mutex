---
title: Deno
description: "Configure Deno language support in Mutex, including language servers, formatting, and debugging."
---
...
See [Configuring supported languages](../configuring-languages.md) in the Mutex documentation for more information.
...
To debug deno programs, add this to `.mutex/debug.json`
...
To run deno tasks like tests from the ui, add this to `.mutex/tasks.json`
