...
Roslyn is enabled by default. To switch to csharp-ls or OmniSharp, add the following to your Mutex settings file:
...
csharp-ls can be configured in a Mutex settings file with:
...
OmniSharp can be configured in a Mutex settings file with:
