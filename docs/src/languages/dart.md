---
title: Dart
description: "Configure Dart language support in Mutex, including language servers, formatting, and debugging."
---
...
If you would like to use a specific dart binary or use dart via FVM you can specify the `dart` binary in your Mutex settings.jsons file:
...
Dart by-default uses a very conservative maximum line length (80). If you would like the dart LSP to permit a longer line length when auto-formatting, add the following to your Mutex settings.json:
