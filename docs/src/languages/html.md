---
title: HTML
description: "Configure HTML language support in Mutex, including language servers, formatting, and debugging."
---
...
By default Mutex uses [Prettier](https://prettier.io/) for formatting HTML.
...
You can customize various [formatting options](https://code.visualstudio.com/docs/languages/html#_formatting) for `vscode-html-language-server` via your Mutex `settings.json`:
