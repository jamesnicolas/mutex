---
title: Julia
description: "Configure Julia language support in Mutex, including language servers, formatting, and debugging."
---

# Julia

Julia language support in Mutex is provided by the community-maintained [Julia extension](https://github.com/JuliaEditorSupport/zed-julia).
