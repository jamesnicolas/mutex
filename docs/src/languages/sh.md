---
title: Shell Script
description: "Configure Shell Script language support in Mutex, including language servers, formatting, and debugging."
---

# Shell Scripts

Shell Scripts (bash, zsh, dash, sh) are supported natively by Mutex.
...
Mutex supports auto-formatting Shell Scripts using external tools like [`shfmt`](https://github.com/mvdan/sh).
...
- [Mutex Docs: Language Support: Bash](./bash.md)
- [Mutex Docs: Language Support: Fish](./fish.md)
