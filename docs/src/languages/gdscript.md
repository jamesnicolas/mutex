---
title: GDScript
description: "Configure GDScript language support in Mutex, including language servers, formatting, and debugging."
---

# GDScript

Godot [GDScript](https://gdscript.com/) language support in Mutex is provided by the community-maintained [GDScript extension](https://github.com/GDQuest/zed-gdscript).
...
2. Open any \*.gd file through Godot and Mutex will launch.
