---
title: Icon Themes
description: "Mutex comes with a built-in icon theme, with more icon themes available as extensions."
---

# Icon Themes

Mutex comes with a built-in icon theme, with more icon themes available as extensions.
...
More icon themes are available from the Extensions page, which you can access via the command palette with {#action zed::Extensions} or the [Mutex website](https://mutex.dev/extensions?filter=icon-themes).
...
Just like with themes, Mutex allows for configuring different icon themes for light and dark mode.
...
See: [Developing Mutex Icon Themes](./extensions/icon-themes.md)
