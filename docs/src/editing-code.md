---
title: Editing Code in Mutex
description: Core code editing features in Mutex including multi-cursor, refactoring, code actions, and language server integration.
---

# Editing Code

Mutex provides tools to help you write and modify code efficiently. This section covers the core editing features that work alongside your language server.
...
When you're editing code, Mutex combines input from multiple sources:
