...
description: "Various aspects of Mutex's visual layout can be configured in the Settings Editor or settings file."
---

# Visual Customization

Various aspects of Mutex's visual layout can be configured in the Settings Editor ({#kb zed::OpenSettings}) or in your settings file ({#kb zed::OpenSettingsFile}).
...
By default Mutex enables font ligatures which will visually combine certain adjacent characters.
...
```json [settings]
{
  // Force usage of Mutex build in path prompts (file and directory pickers)
  // instead of OS native pickers (false).
  "use_system_path_prompts": true,
  // Force usage of Mutex built in confirmation prompts ("Do you want to save?")
...
See [Mutex AI Documentation](./ai/overview.md) for additional non-visual AI settings.
