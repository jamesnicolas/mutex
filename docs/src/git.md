...
To add custom commit instructions for the model, use the global `AGENTS.md` file located `~/.config/mutex/AGENTS.md` on macOS and Linux, `%APPDATA%\Mutex\AGENTS.md` on Windows.
