...
description: "Debugger Extensions for Mutex extensions."
---
...
Mutex offers an automatic way to create debug scenarios with _debug locators_.
...
See DAP servers published as extensions [on Mutex's site](https://mutex.dev/extensions?filter=debug-adapters).
