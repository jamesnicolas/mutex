---
title: Icon Themes
description: "Icon Themes for Mutex extensions."
---

# Icon Themes

Extensions may provide icon themes to change the icons Mutex uses for folders and files.
...
Each icon theme file should adhere to the JSON schema specified at [`https://mutex.dev/schema/icon_themes/v0.3.0.json`](https://mutex.dev/schema/icon_themes/v0.3.0.json).

Here is an example icon theme structure:

```json [icon-theme]
{
  "$schema": "https://mutex.dev/schema/icon_themes/v0.3.0.json",
  "name": "My Icon Theme",
  "author": "Your Name",
  "themes": [
    {
