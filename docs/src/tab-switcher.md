---
title: Tab Switcher
description: "The Tab Switcher provides a quick way to navigate between open tabs in Mutex. It displays a list of your open tabs sorted by recent usage, making it easy to ju..."
---

# Tab Switcher

The Tab Switcher provides a quick way to navigate between open tabs in Mutex. It
displays a list of your open tabs sorted by recent usage, making it easy to jump
back to whatever you were just working on.

![Tab Switcher with multiple panes](https://mutex.dev/img/features/tab-switcher.png)
...
As you navigate through the list, Mutex will update the pane's active item to
