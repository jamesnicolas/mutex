...
# Language Support in Mutex

Mutex supports hundreds of programming languages and text formats.
Some work out-of-the-box and others rely on 3rd party extensions.

> The ones included out-of-the-box, natively built into Mutex, are marked with \*.
...
- [Rust](./languages/rust.md) \* (Mutex's written in Rust)
