---
title: Building Mutex for FreeBSD
description: "Guide to building zed for freebsd for Mutex development."
---

# Building Mutex for FreeBSD
...
See [Issue #15309: FreeBSD Support] and [Discussion #29550: Unofficial FreeBSD port for Mutex] for more.
