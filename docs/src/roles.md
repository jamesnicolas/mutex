---
title: Roles - Mutex
description: Understand Mutex's organization roles and what each role can access, manage, and configure.
---

# Roles

Every member of a Mutex organization is assigned a role that determines what they
...
- Disable Mutex's collaborative features
- Control whether members can use Mutex-hosted models and Mutex's edit predictions
...
Mutex-hosted AI models or Edit Predictions through the Business subscription.
...
Members have standard access to Mutex through the Business subscription. They
cannot access billing or organization settings.

## Managing User Roles {#managing-users}

Owners and Admins can manage organization members from the Mutex dashboard within
the Members page.
...
Removing a member removes their access to organization settings and any organization-managed features. They can continue using Mutex on their own.
