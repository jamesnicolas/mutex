---
title: Extensions
description: "Extend Mutex with themes, language support, AI tools, and more through the extension system."
---

# Extensions

Mutex lets you add new functionality using user-defined extensions.
