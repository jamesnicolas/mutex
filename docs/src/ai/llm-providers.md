---
title: LLM Providers - Mutex
description: Choose how Mutex gets language models: Mutex-hosted models, API access, subscriptions, gateways, or local models.
---

# LLM Providers

Use this page to choose which models power [the Mutex Agent](./zed-agent.md) and
other Mutex-owned AI features, including [Inline Assistant](./inline-assistant.md),
...
| ----------------------------------------------------------------- | --------------------------------------------------------------------- | ------------------------------------- |
| [Use Mutex-Hosted Models](../account/zed-hosted-models.md)          | You want models billed through Mutex                                    | Account & Billing > Mutex-Hosted Models |
...
the difference between the Mutex Agent, External Agents, and Terminal Threads.

## Edit Prediction {#edit-prediction}

[Edit Prediction](./edit-prediction.md) has its own provider setup under `edit_predictions`. LLM providers on this page apply to model-backed Mutex AI features such as Mutex Agent, Inline Assistant, Git commit generation, and thread summaries.
