...
messages!(
    ...
    (GitMergeWorktreeIntoBase, Background),
    (GitMergeWorktreeIntoBaseResponse, Background),
    ...
    (ListAgentThreads, Background),
    (ListAgentThreadsResponse, Background),
    (UpsertAgentThread, Background),
    (RemoveAgentThread, Background),
    (AgentThreadUpdated, Background),
    (AgentThreadRemoved, Background),
    (BeginAgentSignIn, Background),
    (BeginAgentSignInResponse, Background),
    (CompleteAgentSignIn, Background),
    (CompleteAgentSignInResponse, Background),
    (AgentSignOut, Background),
    (GetAgentAuthStatus, Background),
    (AgentAuthStatus, Background),
    (CreateAgentSession, Background),
    (CreateAgentSessionResponse, Background),
    (AgentSessionPrompt, Background),
    (AgentSessionCancel, Background),
    (SubscribeAgentSession, Background),
    (SubscribeAgentSessionResponse, Background),
    (AgentSessionEvent, Background),
    (RespondAgentToolAuthorization, Background),
...
request_messages!(
    ...
    (GitMergeWorktreeIntoBase, GitMergeWorktreeIntoBaseResponse),
    (GitRemoveWorktree, Ack),
    (GitRenameWorktree, Ack),
    (GitWorktreeCreatedAt, GitWorktreeCreatedAtResponse),
    (ListAgentThreads, ListAgentThreadsResponse),
    (UpsertAgentThread, Ack),
    (RemoveAgentThread, Ack),
    (BeginAgentSignIn, BeginAgentSignInResponse),
    (CompleteAgentSignIn, CompleteAgentSignInResponse),
    (AgentSignOut, Ack),
    (GetAgentAuthStatus, AgentAuthStatus),
    (CreateAgentSession, CreateAgentSessionResponse),
    (AgentSessionPrompt, Ack),
    (AgentSessionCancel, Ack),
    (SubscribeAgentSession, SubscribeAgentSessionResponse),
    (RespondAgentToolAuthorization, Ack),
    (TrustWorktrees, Ack),
