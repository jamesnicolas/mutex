...
/// The current extension [`SchemaVersion`] supported by Mutex.
...
/// Returns the [`SchemaVersion`] range that is compatible with this version of Mutex.
pub fn schema_version_range() -> RangeInclusive<SchemaVersion> {
    SchemaVersion::ZERO..=CURRENT_SCHEMA_VERSION
}

/// Returns whether the given extension version is compatible with this version of Mutex.
...
impl ExtensionStore {
    ...
    /// Installs any extensions that should be included with Mutex by default.
    ///
