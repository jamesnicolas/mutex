...
mod tests {
    ...
    #[gpui::test]
    fn test_builtin_language_model_providers_are_codex_only(cx: &mut App) {
        ...
        let provider_ids = registry.read_with(cx, |registry, _| {
            registry
                .providers()
                .into_iter()
        ...
        assert_eq!(provider_ids, vec!["openai-subscribed"]);
    }
