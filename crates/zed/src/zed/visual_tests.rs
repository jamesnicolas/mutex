...
//! Visual testing infrastructure for Mutex.
//!
//! This module provides utilities for visual regression testing of Mutex's UI.
//! It allows capturing screenshots of the real Mutex application window and comparing
...
/// Initialize a visual test context with all necessary Mutex subsystems.
...
mod tests {
    ...
    /// This test captures a screenshot of an empty Mutex workspace.
    ///
