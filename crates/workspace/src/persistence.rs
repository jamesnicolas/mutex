    ...
    const MIGRATIONS: &[&str] = &[
        sql!(
            CREATE TABLE workspaces(
                ...
                dock_visible INTEGER, // Deprecated. Preserving so users can downgrade Mutex.
                dock_anchor TEXT, // Deprecated. Preserving so users can downgrade Mutex.
                dock_pane INTEGER, // Deprecated.  Preserving so users can downgrade Mutex.
        ...
        // Preserving so users can downgrade Mutex.
        sql!(
...
impl WorkspaceDb {
    ...
    // session was closed (i.e. when Mutex was quit).
