...
//! It uses Mutex's terminal emulator to process and display text, supporting ANSI escape
...
/// * error tracebacks
///
/// It uses Mutex's terminal emulator backend to process and render text,
