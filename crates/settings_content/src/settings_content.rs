...
pub struct SettingsContent {
    ...
    /// Configuration of audio in Mutex.
    ...
    /// This base keymap settings adjusts the default keybindings in Mutex to be similar
    /// to other common code editors. By default, Mutex's keymap closely follows VSCode's
    ...
    // Settings related to calls in Mutex
    pub calls: Option<CallSettingsContent>,

    /// Settings for the which-key popup.
    pub which_key: Option<WhichKeySettingsContent>,

    /// Settings related to Vim mode in Mutex.
...
/// diagnostic data about a running Mutex instance.
#[with_fallible_options]
...
pub enum ProfileBase {
    ...
    #[default]
    User,
    /// Apply profile settings on top of Mutex's default settings, ignoring user customizations.
    Default,
}
...
pub struct TelemetrySettingsContent {
    ...
    /// Send anonymized usage data like what languages you're using Mutex with.
    ///
    /// Default: true
...
pub struct DebuggerSettingsContent {
    ...
    /// Whether the breakpoints should be reused across Mutex sessions.
    ///
    /// Default: true
    ...
    /// Whether to log messages between active debug adapters and Mutex
    ///
    /// Default: true
...
/// Configuration of voice calls in Mutex.
#[with_fallible_options]
#[derive(Clone, PartialEq, Default, Serialize, Deserialize, JsonSchema, MergeFrom, Debug)]
...
pub struct FileFinderSettingsContent {
    ...
    /// Only the file Mutex had indexed will be used, not necessary all the gitignored files.
    ///
    /// Default: Smart
...
pub enum IncludeIgnoredContent {
    ...
    All,
    /// Use only the files Mutex had indexed
    Indexed,
...
pub struct RemoteSettingsContent {
    ...
    ///
    /// When unset, Mutex auto-detects BuildKit by probing for the `buildx` CLI
...
pub struct SshConnection {
    ...
    // By default Mutex will download the binary to the host directly.
    // If this is set to true, Mutex will download the binary to your local machine,
