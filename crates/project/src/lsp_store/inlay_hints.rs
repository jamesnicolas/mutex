...
pub enum InvalidationStrategy {
    ...
    /// in addition to LSP capabilities, Mutex allows omitting certain hint kinds (defined by the corresponding LSP part: type/parameter/other) and toggling hints.
