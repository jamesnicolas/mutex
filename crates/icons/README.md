...
Icons are a big part of Mutex, and they're how we convey hundreds of actions without relying on labeled buttons.
...
Then, they're modified, adjusted, cleaned up, and simplified depending on their use and overall fit with Mutex.
...
Make sure to tag a member of Mutex's design team (@zed-industries/design) so we can review and adjust any newly introduced icon.
